...
const DailyAffirmationComponent: React.FunctionComponent<DailyAffirmationProps> = ({ affirmation, onChange }) => {
    return (
        <AffirmationsContainer>
            <SectionHeader>Daily Affirmation</SectionHeader>
            <MarkdownComponent view='edit' value={affirmation} onChange={onChange} height={50} hideToolbar editMode />
        </AffirmationsContainer>
    )
}
